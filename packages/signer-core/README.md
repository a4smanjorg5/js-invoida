...
This module provides utilities to generate and manage cryptographic keys and sign JSON-based document payloads using ES256, CBOR, and JWS (Compact).
...
- Sign CBOR-encoded payloads into Compact JWS format
