...
Invoida is an open-source platform for building secure, verifiable electronic document signing systems. Designed with flexibility in mind, institutions can fully control their signing keys and workflows using standardized formats like JWS and CBOR.

---

## Key Features
- Cryptographic key management (create, store, delete)
- CBOR-based payload signing using Compact JWS
